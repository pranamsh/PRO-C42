...
function preload(){
    ...
    umbrella_animation=loadAnimation("images/WalkingFrame/walking_1.png","images/WalkingFrame/walking_2.png","images/WalkingFrame/walking_3.png"
...
function setup(){
   ...
   umbrella_animation = createSprite(50,160,20,50);
   trex.addAnimation("running",  umbrella_animation);
   trex.scale = 0.5;
